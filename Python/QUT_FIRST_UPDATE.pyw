...
class FirmwareUpdater(Tk):
    def __init__(self):
        ...
        self.title("Orion5 - Firmware Updater - QUT First Update")
        ...
        # Main status
        self.info_label = ttk.Label(self.main_frame, text="Please power on Orion5 while holding middle button, when you see all 3 LEDs flashing, hit update button", justify="center")
        self.info_label.grid(column=0, row=0, columnspan=6, padx=5, pady=5, sticky=(N, S))
        ...
        self.orion5_label.grid(column=0, row=1, columnspan=6, padx=5, pady=5, sticky=(N, S))
